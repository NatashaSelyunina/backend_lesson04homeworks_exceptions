...
public class UserExceptionsTest {
    public static void main(String[] args) {
        ...
        System.out.println("Введенный возвраст - " + age);
    ...
    public static void registration(int age) throws TooBigAgeException {
        if (age < 12) {
            throw new TooSmallAgeException("Возраст не может быть меньше 12 лет");
        }
        if (age > 150) {
            throw new TooBigAgeException("Возраст не может быть больше 150 лет");
        }
